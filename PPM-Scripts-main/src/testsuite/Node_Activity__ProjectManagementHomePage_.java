...
/** Conformiq generated test case
	Node_Activity__ProjectManagementHomePage_
*/
public class Node_Activity__ProjectManagementHomePage_ extends PageObjectBase
{

	public Node_Activity__ProjectManagementHomePage_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__ProjectManagementHomePage_", "TC_Node_Activity__ProjectManagementHomePage_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_6");

	Reporter.log("Step - 7- click ProjectManagement hyperlink HomePage screen");

	testReport.fillTableStep("Step 7", "click ProjectManagement hyperlink HomePage screen");
	Thread.sleep(5000);
	homepage_page_init.click_ProjectManagement_hyperlink();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_7");

	Reporter.log("Step - 8- verify ManageProjectPlan screen");

	testReport.fillTableStep("Step 8", "verify ManageProjectPlan screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_8");

	Reporter.log("Step - 9- click Tasks button ManageProjectPlan screen");

	testReport.fillTableStep("Step 9", "click Tasks button ManageProjectPlan screen");
	Thread.sleep(5000);
	manageprojectplan_page_init.click_Tasks_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_9");

	Reporter.log("Step - 10- verify ManageProjectPlanTasks popup");

	testReport.fillTableStep("Step 10", "verify ManageProjectPlanTasks popup");

	//manageprojectplantasks_page_init.verify_Text("[Don't Care]");
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_10");

	Reporter.log("Step - 11- click OpenProject hyperlink ManageProjectPlanTasks popup");

	testReport.fillTableStep("Step 11", "click OpenProject hyperlink ManageProjectPlanTasks popup");
	Thread.sleep(5000);
	manageprojectplantasks_page_init.click_OpenProject_hyperlink();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_11");

	Reporter.log("Step - 12- verify Open popup");

	testReport.fillTableStep("Step 12", "verify Open popup");

	//open_page_init.verify_Text("[Don't Care]");
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_12");

	Reporter.log("Step - 13- Fill OpenFile form Open popup");

	testReport.fillTableStep("Step 13", "Fill OpenFile form Open popup");
	Thread.sleep(5000);
	//open_page_init.set_FileName_textbox(Step_13_FileName_textbox_TEXTBOX);
	open_page_init.set_FileName_textbox("T3Test_PR_0");
	Thread.sleep(5000);
	driver.findElement(By.xpath("//input[contains(@id,'_FOTsr1:0:nameId')]")).sendKeys(Keys.TAB);
	Thread.sleep(5000);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_13");

	Reporter.log("Step - 14- click Open button Open popup");

	testReport.fillTableStep("Step 14", "click Open button Open popup");
	Thread.sleep(5000);
	open_page_init.click_Open_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_14");

	Reporter.log("Step - 15- verify ManageProjectPlan screen");

	testReport.fillTableStep("Step 15", "verify ManageProjectPlan screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_15");

	Reporter.log("Step - 16- click Tasks button ManageProjectPlan screen");

	testReport.fillTableStep("Step 16", "click Tasks button ManageProjectPlan screen");
	Thread.sleep(5000);
	manageprojectplan_page_init.click_Tasks_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_16");

	Reporter.log("Step - 17- verify ManageProjectPlanTasks popup");

	testReport.fillTableStep("Step 17", "verify ManageProjectPlanTasks popup");

	//manageprojectplantasks_page_init.verify_Text("[Don't Care]");
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_17");

	Reporter.log("Step - 18- click ManageProjectCosts hyperlink ManageProjectPlanTasks popup");

	testReport.fillTableStep("Step 18", "click ManageProjectCosts hyperlink ManageProjectPlanTasks popup");
	Thread.sleep(5000);
	//manageprojectplantasks_page_init.click_ManageProjectCosts_hyperlink();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_18");

	Reporter.log("Step - 19- click ManageProjectInvoices hyperlink ManageProjectPlanTasks popup");

	testReport.fillTableStep("Step 19", "click ManageProjectInvoices hyperlink ManageProjectPlanTasks popup");
	Thread.sleep(5000);
	manageprojectplan_page_init.click_Tasks_button();

	Thread.sleep(5000);
	//manageprojectplantasks_page_init.click_ManageProjectInvoices_hyperlink();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_19");

	Reporter.log("Step - 20- click AnalyzeKPICategories hyperlink ManageProjectPlanTasks popup");

	testReport.fillTableStep("Step 20", "click AnalyzeKPICategories hyperlink ManageProjectPlanTasks popup");
	Thread.sleep(5000);
	manageprojectplan_page_init.click_Tasks_button();

	Thread.sleep(5000);
	//manageprojectplantasks_page_init.click_AnalyzeKPICategories_hyperlink();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ProjectManagementHomePage_","Step_20");
	}
	...
	public void export(){
		...
		//driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__ProjectManagementHomePage_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
