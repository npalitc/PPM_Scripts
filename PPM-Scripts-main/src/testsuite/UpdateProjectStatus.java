...
/** Conformiq generated test case
	UpdateProjectStatus
*/
public class UpdateProjectStatus extends PageObjectBase
{
	...
	testReport.generateGeneralInfo(overallTestData, "UpdateProjectStatus", "TC_UpdateProjectStatus", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_7");

	Reporter.log("Step - 8- verify PFMMyProjects screen");

	testReport.fillTableStep("Step 8", "verify PFMMyProjects screen");

	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_11");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_12");

	Reporter.log("Step - 13- verify ProjectOverview screen");

	testReport.fillTableStep("Step 13", "verify ProjectOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_13");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_14");
	Thread.sleep(5000);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_15");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_16");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_17");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_18");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_19");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_20");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "UpdateProjectStatus","Step_21");
	}
