...
/** Conformiq generated test case
	Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_
*/
public class Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_ extends PageObjectBase
{

	public Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_", "TC_Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_7");

	Reporter.log("Step - 8- verify PFMMyProjects screen");

	testReport.fillTableStep("Step 8", "verify PFMMyProjects screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_10");
	...
	Thread.sleep(5000);
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_11");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_12");

	Reporter.log("Step - 13- verify ProjectOverview screen");

	testReport.fillTableStep("Step 13", "verify ProjectOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_13");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_14");
	driver.findElement(By.xpath("//*[contains(@id,'sdi2::icon')]")).click();
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_15");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_16");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_17");

	Reporter.log("Step - 18- click Parties hyperlink ManageFinProjectSettings screen");

	testReport.fillTableStep("Step 18", "click Parties hyperlink ManageFinProjectSettings screen");
	Thread.sleep(5000);
	managefinprojectsettings_page_init.click_Parties_hyperlink();
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_18");

	Reporter.log("Step - 19- click AddTeamMember button ManageFinProjectSettings screen");

	testReport.fillTableStep("Step 19", "click AddTeamMember button ManageFinProjectSettings screen");
	Thread.sleep(5000);
	managefinprojectsettings_page_init.click_AddTeamMember_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_19");

	Reporter.log("Step - 20- verify AddTeamMembers popup");

	testReport.fillTableStep("Step 20", "verify AddTeamMembers popup");

	//addteammembers_page_init.verify_Text("[Don't Care]");
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_20");

	Reporter.log("Step - 21- Fill AddTeamMembers form AddTeamMembers popup");

	testReport.fillTableStep("Step 21", "Fill AddTeamMembers form AddTeamMembers popup");
	Thread.sleep(5000);
	addteammembers_page_init.set_Person_textbox(Step_21_Person_textbox_TEXTBOX);
	//addteammembers_page_init.set_StartDate_textbox(Step_21_StartDate_textbox_TEXTBOX);
	//addteammembers_page_init.select_ProjectRole_dropdown(Step_21_ProjectRole_dropdown_DROPDOWN);
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_21");

	Reporter.log("Step - 22- click SaveAndClose button AddTeamMembers popup");

	testReport.fillTableStep("Step 22", "click SaveAndClose button AddTeamMembers popup");
	Thread.sleep(5000);
	addteammembers_page_init.click_SaveAndClose_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_22");

	Reporter.log("Step - 23- click Done button ManageFinProjectSettings screen");

	testReport.fillTableStep("Step 23", "click Done button ManageFinProjectSettings screen");
	Thread.sleep(5000);
	managefinprojectsettings_page_init.click_Done_button();
	Thread.sleep(5000);
	getScreenshot(driver,Configurations.screenshotLocation , "Move_from_Event__Event_Node_5__to_Activity__AddTeamMembers_","Step_23");
	}
