...
/** Conformiq generated test case
	Node_Activity__AddFinResurcesToATask_
*/
public class Node_Activity__AddFinResurcesToATask_ extends PageObjectBase
{

	public Node_Activity__AddFinResurcesToATask_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__AddFinResurcesToATask_", "TC_Node_Activity__AddFinResurcesToATask_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_7");

	Reporter.log("Step - 8- verify PFMMyProjects screen");

	testReport.fillTableStep("Step 8", "verify PFMMyProjects screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_11");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_12");

	Reporter.log("Step - 13- verify ProjectOverview screen");

	testReport.fillTableStep("Step 13", "verify ProjectOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_13");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_14");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_15");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_16");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_17");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_18");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_19");
	...
	//managefinprojectplan_page_init.click_SelectSubTaskRow_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_20");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_21");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_22");

	Reporter.log("Step - 23- click ResourcesBtn button ManageFinProjectPlan screen");

	testReport.fillTableStep("Step 23", "click ResourcesBtn button ManageFinProjectPlan screen");
	Thread.sleep(5000);
	//managefinprojectplan_page_init.click_ResourcesBtn_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_23");

	Reporter.log("Step - 24- verify ManageResources popup");

	testReport.fillTableStep("Step 24", "verify ManageResources popup");

	//manageresources_page_init.verify_Text("[Don't Care]");
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_24");

	Reporter.log("Step - 25- Fill ManageResources form ManageResources popup");

	testReport.fillTableStep("Step 25", "Fill ManageResources form ManageResources popup");
	Thread.sleep(5000);
	
	//driver.findElement(By.xpath("//*[contains(@id,'irB::icon')]")).click();
	Thread.sleep(5000);
	//manageresources_page_init.set_Resource_textbox(Step_25_Resource_textbox_TEXTBOX);
	//manageresources_page_init.set_PlannedBudgetAmt_textbox(Step_25_PlannedBudgetAmt_textbox_TEXTBOX);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_25");

	Reporter.log("Step - 26- click SaveAndClose button ManageResources popup");

	testReport.fillTableStep("Step 26", "click SaveAndClose button ManageResources popup");
	Thread.sleep(5000);
	
	//manageresources_page_init.click_SaveAndClose_button();
	Thread.sleep(5000);
	//driver.findElement(By.xpath("//*[contains(@id,'_FOd1::msgDlg::cancel')]")).click();
	
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_26");

	Reporter.log("Step - 27- click SaveAndClose button ManageFinProjectPlan screen");

	testReport.fillTableStep("Step 27", "click SaveAndClose button ManageFinProjectPlan screen");
	Thread.sleep(5000);
	managefinprojectplan_page_init.click_SaveAndClose_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__AddFinResurcesToATask_","Step_27");
	}
	...
	public void export(){
		...
		//driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__AddFinResurcesToATask_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
