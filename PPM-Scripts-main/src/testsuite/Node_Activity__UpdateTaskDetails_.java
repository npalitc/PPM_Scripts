...
/** Conformiq generated test case
	Node_Activity__UpdateTaskDetails_
*/
public class Node_Activity__UpdateTaskDetails_ extends PageObjectBase
{

	public Node_Activity__UpdateTaskDetails_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__UpdateTaskDetails_", "TC_Node_Activity__UpdateTaskDetails_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_7");

	Reporter.log("Step - 8- verify PFMMyProjects screen");

	testReport.fillTableStep("Step 8", "verify PFMMyProjects screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_11");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_12");

	Reporter.log("Step - 13- verify ProjectOverview screen");

	testReport.fillTableStep("Step 13", "verify ProjectOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_13");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_14");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_15");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_16");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_17");
...
//	managefinprojectplan_page_init.click_SelectMainTask_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_18");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_19");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_20");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_21");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_22");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_23");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_24");
	
	Reporter.log("Step - 25- Fill General form EditTaskDetails popup");

	testReport.fillTableStep("Step 25", "Fill General form EditTaskDetails popup");
	Thread.sleep(5000);
	edittaskdetails_page_init.set_Description_textbox(Step_25_Description_textbox_TEXTBOX);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_25");
	Thread.sleep(5000);
	driver.findElement(By.xpath("//*[contains(@id,'ap1:ppDetD::ok')]")).click();
		/*
		 * Reporter.log("Step - 26- click Setup hyperlink EditTaskDetails popup");
		 * 
		 * testReport.fillTableStep("Step 26",
		 * "click Setup hyperlink EditTaskDetails popup"); Thread.sleep(5000);
		 * edittaskdetails_page_init.click_Setup_hyperlink();
		 * getScreenshot(driver,Configurations.screenshotLocation ,
		 * "Node_Activity__UpdateTaskDetails_","Step_26");
		 * 
		 ...
		 * Thread.sleep(5000); edittaskdetails_page_init.select_Billable_checkbox(
		 * Step_27_Billable_checkbox_CHECKBOX);
		 * edittaskdetails_page_init.select_WorkType_dropdown(
		 * Step_27_WorkType_dropdown_DROPDOWN);
		 * edittaskdetails_page_init.select_ServiceType_dropdown(
		 * Step_27_ServiceType_dropdown_DROPDOWN);
		 * getScreenshot(driver,Configurations.screenshotLocation ,
		 * "Node_Activity__UpdateTaskDetails_","Step_27");
		 */

	Reporter.log("Step - 28- click SaveAndClose button EditTaskDetails popup");

	testReport.fillTableStep("Step 28", "click SaveAndClose button EditTaskDetails popup");
	Thread.sleep(5000);
	edittaskdetails_page_init.click_SaveAndClose_button();
	Thread.sleep(10000);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskDetails_","Step_28");
	}
