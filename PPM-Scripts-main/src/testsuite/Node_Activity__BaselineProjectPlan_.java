...
/** Conformiq generated test case
	Node_Activity__BaselineProjectPlan_
*/
public class Node_Activity__BaselineProjectPlan_ extends PageObjectBase
{

	public Node_Activity__BaselineProjectPlan_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__BaselineProjectPlan_", "TC_Node_Activity__BaselineProjectPlan_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_7");

	Reporter.log("Step - 8- verify PFMMyProjects screen");

	testReport.fillTableStep("Step 8", "verify PFMMyProjects screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_11");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_12");

	Reporter.log("Step - 13- verify ProjectOverview screen");

	testReport.fillTableStep("Step 13", "verify ProjectOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_13");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_14");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_15");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_16");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_17");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_18");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_19");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_20");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__BaselineProjectPlan_","Step_21");

	Reporter.log("Step - 22- click Submit button SetBaselineForProjectPlan popup");

	testReport.fillTableStep("Step 22", "click Submit button SetBaselineForProjectPlan popup");
	Thread.sleep(5000);
	...
	public void export(){
		...
		//driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__BaselineProjectPlan_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
