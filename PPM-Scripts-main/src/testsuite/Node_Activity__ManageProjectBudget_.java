...
/** Conformiq generated test case
	Node_Activity__ManageProjectBudget_
*/
public class Node_Activity__ManageProjectBudget_ extends PageObjectBase
{

	public Node_Activity__ManageProjectBudget_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__ManageProjectBudget_", "TC_Node_Activity__ManageProjectBudget_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_7");

	Reporter.log("Step - 8- verify PFMMyProjects screen");

	testReport.fillTableStep("Step 8", "verify PFMMyProjects screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_11");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_12");

	Reporter.log("Step - 13- verify ProjectOverview screen");

	testReport.fillTableStep("Step 13", "verify ProjectOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_13");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_15");

	Reporter.log("Step - 16- click ManageProjectBudget hyperlink ProjectOverviewTasks popup");

	testReport.fillTableStep("Step 16", "click ManageProjectBudget hyperlink ProjectOverviewTasks popup");
	Thread.sleep(5000);
	projectoverviewtasks_page_init.click_ManageProjectBudget_hyperlink();
	Thread.sleep(5000);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_16");

	Reporter.log("Step - 17- verify ManageBudgetVersions screen");

	testReport.fillTableStep("Step 17", "verify ManageBudgetVersions screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_17");

	Reporter.log("Step - 18- click VersionName hyperlink ManageBudgetVersions screen");

	testReport.fillTableStep("Step 18", "click VersionName hyperlink ManageBudgetVersions screen");
	Thread.sleep(5000);
	managebudgetversions_page_init.click_VersionName_hyperlink();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_18");

	Reporter.log("Step - 19- verify EditBudget screen");

	testReport.fillTableStep("Step 19", "verify EditBudget screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_19");

	Reporter.log("Step - 20- click Submit button EditBudget screen");

	testReport.fillTableStep("Step 20", "click Submit button EditBudget screen");
	Thread.sleep(5000);
	editbudget_page_init.click_Submit_button();
	Thread.sleep(5000);
	//driver.findElement(By.xpath("//button[contains(@id,'commandButton14')]")).click();
	//Thread.sleep(5000);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ManageProjectBudget_","Step_20");
	}
	...
	public void export(){
		...
		//driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__ManageProjectBudget_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
