...
/** Conformiq generated test case
	Node_Activity__OpenAccountingPeriod_
*/
public class Node_Activity__OpenAccountingPeriod_ extends PageObjectBase
{

	public Node_Activity__OpenAccountingPeriod_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__OpenAccountingPeriod_", "TC_Node_Activity__OpenAccountingPeriod_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_7");

	Reporter.log("Step - 8- verify CostsOverview screen");

	testReport.fillTableStep("Step 8", "verify CostsOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_11");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_12");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_13");

	Reporter.log("Step - 14- click OpenNextPeriod button ManageAccountingPeriods screen");

	testReport.fillTableStep("Step 14", "click OpenNextPeriod button ManageAccountingPeriods screen");
	Thread.sleep(5000);
	manageaccountingperiods_page_init.click_OpenNextPeriod_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_14");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_15");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__OpenAccountingPeriod_","Step_16");
	}
	...
	public void export(){
		...
		//driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__OpenAccountingPeriod_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
