...
/** Conformiq generated test case
	Node_Activity__CloseAccountingPeriod_
*/
public class Node_Activity__CloseAccountingPeriod_ extends PageObjectBase
{

	public Node_Activity__CloseAccountingPeriod_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__CloseAccountingPeriod_", "TC_Node_Activity__CloseAccountingPeriod_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_7");

	Reporter.log("Step - 8- verify CostsOverview screen");

	testReport.fillTableStep("Step 8", "verify CostsOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_10");

	Reporter.log("Step - 11- click ManageAccountingPeriods hyperlink CostsTasks popup");

	testReport.fillTableStep("Step 11", "click ManageAccountingPeriods hyperlink CostsTasks popup");
	Thread.sleep(5000);
	coststasks_page_init.click_ManageAccountingPeriods_hyperlink();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_11");

	Reporter.log("Step - 12- verify ManageAccountingPeriods screen");

	testReport.fillTableStep("Step 12", "verify ManageAccountingPeriods screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_12");

	Reporter.log("Step - 13- click SelectLedger button ManageAccountingPeriods screen");

	testReport.fillTableStep("Step 13", "click SelectLedger button ManageAccountingPeriods screen");
	Thread.sleep(5000);
	manageaccountingperiods_page_init.click_SelectLedger_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_13");

	Reporter.log("Step - 14- click CloseCurrentPeriod button ManageAccountingPeriods screen");

	testReport.fillTableStep("Step 14", "click CloseCurrentPeriod button ManageAccountingPeriods screen");
	Thread.sleep(5000);
	//driver.findElement(By.xpath("")).click();
	manageaccountingperiods_page_init.click_CloseCurrentPeriod_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_14");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_15");

	Reporter.log("Step - 16- click MangeAccPeriodYesBtn button Confirmation popup");

	testReport.fillTableStep("Step 16", "click MangeAccPeriodYesBtn button Confirmation popup");
	Thread.sleep(5000);
	confirmation_page_init.click_MangeAccPeriodYesBtn_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__CloseAccountingPeriod_","Step_16");
	}
	...
	public void export(){
		...
		//driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__CloseAccountingPeriod_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
