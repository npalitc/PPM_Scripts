...
/** Conformiq generated test case
	ApproveProjectStatusChange
*/
public class ApproveProjectStatusChange extends PageObjectBase
{

	public ApproveProjectStatusChange()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "ApproveProjectStatusChange", "TC_ApproveProjectStatusChange", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_7");

	Reporter.log("Step - 8- verify PFMMyProjects screen");

	testReport.fillTableStep("Step 8", "verify PFMMyProjects screen");

	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_9");
	...
	Thread.sleep(5000);
	//driver.findElement(By.xpath("//input[contains(@id,'AP1:q1:value100')]")).click();
	Thread.sleep(2000);
	//driver.findElement(By.xpath("//input[contains(@id,'saId')]")).click();
	Thread.sleep(5000);
	pfmmyprojects_page_init.set_TeamMember_textbox(Step_10_TeamMember_textbox_TEXTBOX);
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_11");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_12");

	Reporter.log("Step - 13- verify ProjectOverview screen");

	testReport.fillTableStep("Step 13", "verify ProjectOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_13");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_14");
	driver.findElement(By.xpath("//*[contains(@id,'sdi2::icon')]")).click(); //Tasks
	//*[contains(@id,'sdi2::icon')]
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_15");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_16");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_17");

	Reporter.log("Step - 18- click ChangeStatus button ManageFinProjectSettings screen");

	testReport.fillTableStep("Step 18", "click ChangeStatus button ManageFinProjectSettings screen");
	Thread.sleep(5000);
	managefinprojectsettings_page_init.click_ChangeStatus_button();
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_18");

	Reporter.log("Step - 19- verify ChangeProjectStatus popup");

	testReport.fillTableStep("Step 19", "verify ChangeProjectStatus popup");

	//changeprojectstatus_page_init.verify_Text("[Don't Care]");
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_19");

	Reporter.log("Step - 20- Fill ChangeProjectStatus form ChangeProjectStatus popup");

	testReport.fillTableStep("Step 20", "Fill ChangeProjectStatus form ChangeProjectStatus popup");
	Thread.sleep(5000);
	changeprojectstatus_page_init.select_To_dropdown(Step_20_To_dropdown_DROPDOWN);
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_20");

	Reporter.log("Step - 21- click SaveAndClose button ChangeProjectStatus popup");

	testReport.fillTableStep("Step 21", "click SaveAndClose button ChangeProjectStatus popup");
	Thread.sleep(5000);
	changeprojectstatus_page_init.click_SaveAndClose_button();
	Thread.sleep(5000);
	driver.findElement(By.xpath("//*[contains(@id,'PrjFndProjectDefinitionPage:cb_done')]")).click();
	
	getScreenshot(driver,Configurations.screenshotLocation , "ApproveProjectStatusChange","Step_21");
	}
	private void clickElement(By linkText) {
	...
	public void export(){
		...
		//driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "ApproveProjectStatusChange");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
