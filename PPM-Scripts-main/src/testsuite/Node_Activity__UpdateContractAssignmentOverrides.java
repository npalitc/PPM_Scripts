...
/** Conformiq generated test case
	Node_Activity__UpdateContractAssignmentOverrides
*/
public class Node_Activity__UpdateContractAssignmentOverrides extends PageObjectBase
{

	public Node_Activity__UpdateContractAssignmentOverrides()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__UpdateContractAssignmentOverrides", "TC_Node_Activity__UpdateJobAssignmentOverrides___2_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_7");

	Reporter.log("Step - 8- verify Contracts screen");

	testReport.fillTableStep("Step 8", "verify Contracts screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_10");

	Reporter.log("Step - 11- verify Contracts screen");

	testReport.fillTableStep("Step 11", "verify Contracts screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_11");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_12");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_13");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_14");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_15");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_16");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_17");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_18");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_19");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_20");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_21");

	Reporter.log("Step - 22- click ExpandJobAssignmentOverrides  button EditContracts EditBillPlan screen SchedulesandOverrides form");

	testReport.fillTableStep("Step 22", "click ExpandJobAssignmentOverrides  button EditContracts EditBillPlan screen SchedulesandOverrides form");
	Thread.sleep(5000);
	editcontracts_editbillplan_page_init.click_ExpandJobAssignmentOverrides__button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_22");

	Reporter.log("Step - 23- click JAAddBtn button EditContracts EditBillPlan screen SchedulesandOverrides form");

	testReport.fillTableStep("Step 23", "click JAAddBtn button EditContracts EditBillPlan screen SchedulesandOverrides form");
	//Thread.sleep(5000);
	//editcontracts_editbillplan_page_init.click_JAAddBtn_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_23");
	...
	//Thread.sleep(5000);
	//editcontracts_editbillplan_page_init.set_JASearchName_textbox(Step_24_JASearchName_textbox_TEXTBOX);
	//Thread.sleep(5000);
	//editcontracts_editbillplan_page_init.set_JAContractLineNumber_textbox(Step_24_JAContractLineNumber_textbox_TEXTBOX);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_24");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateContractAssignmentOverrides","Step_25");
	}
	...
	public void export(){
		...
		//driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__UpdateContractAssignmentOverrides");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
