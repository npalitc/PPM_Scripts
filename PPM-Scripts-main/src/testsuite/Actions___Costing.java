...
/** Conformiq generated test case
	Actions___Costing
*/
public class Actions___Costing extends PageObjectBase
{

	public Actions___Costing()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Actions___Costing", "TC_Actions___Costing", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_7");

	Reporter.log("Step - 8- verify CostsOverview screen");

	testReport.fillTableStep("Step 8", "verify CostsOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_8");
	Thread.sleep(5000);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_9");
	...
	//getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_11");

	Reporter.log("Step - 12- verify ManageProjectCosts screen");

	testReport.fillTableStep("Step 12", "verify ManageProjectCosts screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_12");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_14");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_15");

	Reporter.log("Step - 16- verify ExpenditureItem screen");

	testReport.fillTableStep("Step 16", "verify ExpenditureItem screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_16");
	...
	Thread.sleep(5000);
	driver.findElement(By.xpath("//td[contains(text(),'Costing')]")).click();
	Thread.sleep(5000);
	driver.findElement(By.xpath("//td[contains(text(),'Recalculate Raw Cost Amount')]")).click();
	Thread.sleep(5000);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_17");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Actions___Costing","Step_18");
	}
	...
	public void export(){
		...
		//driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Actions___Costing");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
