...
/** Conformiq generated test case
	Node_Activity__UpdateTaskServiceType_
*/
public class Node_Activity__UpdateTaskServiceType_ extends PageObjectBase
{

	public Node_Activity__UpdateTaskServiceType_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__UpdateTaskServiceType_", "TC_Node_Activity__UpdateTaskServiceType_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_7");

	Reporter.log("Step - 8- verify PFMMyProjects screen");

	testReport.fillTableStep("Step 8", "verify PFMMyProjects screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_11");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_12");

	Reporter.log("Step - 13- verify ProjectOverview screen");

	testReport.fillTableStep("Step 13", "verify ProjectOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_13");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_14");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_15");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_16");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_17");
	...
	Thread.sleep(5000);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_18");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_19");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_20");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_21");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_22");

	Reporter.log("Step - 23- click DetailsBtn button ManageFinProjectPlan screen");

	testReport.fillTableStep("Step 23", "click DetailsBtn button ManageFinProjectPlan screen");
	...
	Thread.sleep(5000);
	driver.findElement(By.xpath("//td[contains(text(),'Edit Task Details')]")).click();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_23");

	Reporter.log("Step - 24- verify EditTaskDetails popup");

	testReport.fillTableStep("Step 24", "verify EditTaskDetails popup");
	
	//edittaskdetails_page_init.verify_Text("[Don't Care]");
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_24");

	Reporter.log("Step - 25- click Setup hyperlink EditTaskDetails popup");

	testReport.fillTableStep("Step 25", "click Setup hyperlink EditTaskDetails popup");
	Thread.sleep(5000);
	edittaskdetails_page_init.click_Setup_hyperlink();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_25");

	Reporter.log("Step - 26- Fill EditTaskDetails form EditTaskDetails popup");

	testReport.fillTableStep("Step 26", "Fill EditTaskDetails form EditTaskDetails popup");
	Thread.sleep(5000);
	edittaskdetails_page_init.select_TaskNum_dropdown(Step_26_TaskNum_dropdown_DROPDOWN);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_26");

	Reporter.log("Step - 27- Fill Setup form EditTaskDetails popup");

	testReport.fillTableStep("Step 27", "Fill Setup form EditTaskDetails popup");
	Thread.sleep(5000);
	edittaskdetails_page_init.select_ServiceType_dropdown(Step_27_ServiceType_dropdown_DROPDOWN);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_27");

	Reporter.log("Step - 28- Fill EditTaskDetails form EditTaskDetails popup");

	testReport.fillTableStep("Step 28", "Fill EditTaskDetails form EditTaskDetails popup");
	Thread.sleep(5000);
	edittaskdetails_page_init.select_TaskNum_dropdown(Step_28_TaskNum_dropdown_DROPDOWN);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_28");

	Reporter.log("Step - 29- Fill Setup form EditTaskDetails popup");

	testReport.fillTableStep("Step 29", "Fill Setup form EditTaskDetails popup");
	Thread.sleep(5000);
	edittaskdetails_page_init.select_ServiceType_dropdown(Step_29_ServiceType_dropdown_DROPDOWN);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_29");

	Reporter.log("Step - 30- Fill EditTaskDetails form EditTaskDetails popup");

	testReport.fillTableStep("Step 30", "Fill EditTaskDetails form EditTaskDetails popup");
	Thread.sleep(5000);
	edittaskdetails_page_init.select_TaskNum_dropdown(Step_30_TaskNum_dropdown_DROPDOWN);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_30");

	Reporter.log("Step - 31- Fill Setup form EditTaskDetails popup");

	testReport.fillTableStep("Step 31", "Fill Setup form EditTaskDetails popup");
	Thread.sleep(5000);
	edittaskdetails_page_init.select_ServiceType_dropdown(Step_31_ServiceType_dropdown_DROPDOWN);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_31");

	Reporter.log("Step - 32- Fill EditTaskDetails form EditTaskDetails popup");
	...
	testReport.fillTableStep("Step 33", "Fill Setup form EditTaskDetails popup");
	Thread.sleep(5000);
	edittaskdetails_page_init.select_ServiceType_dropdown(Step_33_ServiceType_dropdown_DROPDOWN);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateTaskServiceType_","Step_33");

	Reporter.log("Step - 34- click SaveAndClose button EditTaskDetails popup");
	...
	public void export(){
		...
		//driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__UpdateTaskServiceType_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
