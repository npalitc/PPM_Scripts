...
/** Conformiq generated test case
	Node_Activity__ResolveCostTransactionExceptions_
*/
public class Node_Activity__ResolveCostTransactionExceptions_ extends PageObjectBase
{

	public Node_Activity__ResolveCostTransactionExceptions_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__ResolveCostTransactionExceptions_", "TC_Node_Activity__ResolveCostTransactionExceptions_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_7");

	Reporter.log("Step - 8- verify CostsOverview screen");

	testReport.fillTableStep("Step 8", "verify CostsOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_8");
	Thread.sleep(5000);
	Reporter.log("Step - 9- click Exceptions hyperlink CostsOverview screen");

	testReport.fillTableStep("Step 9", "click Exceptions hyperlink CostsOverview screen");
	driver.findElement(By.xpath("//*[contains(@id,'sdh3::_afrDscl')]")).click();//Expand Transactions
	Thread.sleep(5000);
	costsoverview_page_init.click_Exceptions_hyperlink();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_9");

	Reporter.log("Step - 10- click ExceptionNum hyperlink CostsOverview screen");

	testReport.fillTableStep("Step 10", "click ExceptionNum hyperlink CostsOverview screen");
	Thread.sleep(5000);
	costsoverview_page_init.click_ExceptionNum_hyperlink();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_10");

	Reporter.log("Step - 11- verify ManageUnprocessedCosts screen");

	testReport.fillTableStep("Step 11", "verify ManageUnprocessedCosts screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_11");

	Reporter.log("Step - 12- click SelectRow button ManageUnprocessedCosts screen");

	testReport.fillTableStep("Step 12", "click SelectRow button ManageUnprocessedCosts screen");
	Thread.sleep(5000);
	manageunprocessedcosts_page_init.click_SelectRow_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_12");

	Reporter.log("Step - 13- Fill SearchResults form ManageUnprocessedCosts screen");

	testReport.fillTableStep("Step 13", "Fill SearchResults form ManageUnprocessedCosts screen");
	Thread.sleep(5000);
	//manageunprocessedcosts_page_init.select_Actions_dropdown(Step_13_Actions_dropdown_DROPDOWN);
	driver.findElement(By.linkText("Actions")).click();
	//Thread.sleep(2000);
	Thread.sleep(5000);
	driver.findElement(By.xpath("//tr[contains(@id,'_ATp:editMenuItem')]//*[contains(text(),'Edit')]")).click();;
	
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_13");

	Reporter.log("Step - 14- verify EditTransaction screen");

	testReport.fillTableStep("Step 14", "verify EditTransaction screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_14");

	Reporter.log("Step - 15- Fill EditTransaction form EditTransaction screen");

	testReport.fillTableStep("Step 15", "Fill EditTransaction form EditTransaction screen");
	Thread.sleep(5000);
	
	//driver.findElement(By.xpath("//a[contains(@id,'AP1:ctb1::popE')]")).click();
	//Thread.sleep(5000);

	//CLICK SAVE AND CLOSE?
	//edittransaction_page_init.select_Save_dropdown(Step_15_Save_dropdown_DROPDOWN);
//	edittransaction_page_init.set_TransactionCurrency_textbox(Step_15_TransactionCurrency_textbox_TEXTBOX);
//	edittransaction_page_init.set_RawCost_textbox(Step_15_RawCost_textbox_TEXTBOX);
//	edittransaction_page_init.set_BurdenedCost_textbox(Step_15_BurdenedCost_textbox_TEXTBOX);
		/*
		 * getScreenshot(driver,Configurations.screenshotLocation ,
		 * "Node_Activity__ResolveCostTransactionExceptions_","Step_15");
		 * 
		 * Reporter.log("Step - 16- verify ManageUnprocessedCosts screen");
		 * 
		 * testReport.fillTableStep("Step 16", "verify ManageUnprocessedCosts screen");
		 * 
		 * getScreenshot(driver,Configurations.screenshotLocation ,
		 * "Node_Activity__ResolveCostTransactionExceptions_","Step_16");
		 * 
		 * Reporter.log("Step - 17- click Done button ManageUnprocessedCosts screen");
		 * 
		 * testReport.fillTableStep("Step 17",
		 * "click Done button ManageUnprocessedCosts screen"); Thread.sleep(5000);
		 * manageunprocessedcosts_page_init.click_Done_button();
		 */
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__ResolveCostTransactionExceptions_","Step_17");
	}
	...
	public void export(){
		...
		driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__ResolveCostTransactionExceptions_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
