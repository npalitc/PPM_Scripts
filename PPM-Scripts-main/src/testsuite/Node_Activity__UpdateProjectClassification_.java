...
/** Conformiq generated test case
	Node_Activity__UpdateProjectClassification_
*/
public class Node_Activity__UpdateProjectClassification_ extends PageObjectBase
{

	public Node_Activity__UpdateProjectClassification_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__UpdateProjectClassification_", "TC_Node_Activity__UpdateProjectClassification_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_7");

	Reporter.log("Step - 8- verify PFMMyProjects screen");

	testReport.fillTableStep("Step 8", "verify PFMMyProjects screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_11");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_12");

	Reporter.log("Step - 13- verify ProjectOverview screen");

	testReport.fillTableStep("Step 13", "verify ProjectOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_13");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_14");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_15");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_16");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_17");

	Reporter.log("Step - 18- click ProjectClassificationEdit button ManageFinProjectSettings screen");

	testReport.fillTableStep("Step 18", "click ProjectClassificationEdit button ManageFinProjectSettings screen");
	Thread.sleep(5000);
	managefinprojectsettings_page_init.click_ProjectClassificationEdit_button();
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_18");

	Reporter.log("Step - 19- verify EditProjectClassification popup");

	testReport.fillTableStep("Step 19", "verify EditProjectClassification popup");

	//editprojectclassification_page_init.verify_Text("[Don't Care]");
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_19");

	Reporter.log("Step - 20- Fill EditProjectClassification form EditProjectClassification popup");

	testReport.fillTableStep("Step 20", "Fill EditProjectClassification form EditProjectClassification popup");
	Thread.sleep(5000);
	editprojectclassification_page_init.set_ClassCode_textbox(Step_20_ClassCode_textbox_TEXTBOX);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_20");

	Reporter.log("Step - 21- click SaveAndClose button EditProjectClassification popup");

	testReport.fillTableStep("Step 21", "click SaveAndClose button EditProjectClassification popup");
	Thread.sleep(5000);
	new Actions(driver).sendKeys(Keys.TAB).perform();
	Thread.sleep(5000);
	editprojectclassification_page_init.click_SaveAndClose_button();
	Thread.sleep(5000);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__UpdateProjectClassification_","Step_21");
	}
	...
	public void export(){
		...
		//driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__UpdateProjectClassification_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
