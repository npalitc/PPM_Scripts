...
/** Conformiq generated test case
	Node_Activity__TransferCosts_
*/
public class Node_Activity__TransferCosts_ extends PageObjectBase
{

	public Node_Activity__TransferCosts_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "Node_Activity__TransferCosts_", "TC_Node_Activity__TransferCosts_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_7");

	Reporter.log("Step - 8- verify CostsOverview screen");

	testReport.fillTableStep("Step 8", "verify CostsOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_8");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_9");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_10");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_11");

	Reporter.log("Step - 12- verify ManageProjectCosts screen");

	testReport.fillTableStep("Step 12", "verify ManageProjectCosts screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_12");
	...
	Thread.sleep(5000);
	driver.findElement(By.xpath("//tr[contains(@id,'commandMenuItem1')]//td[@class='xnw'][contains(text(),'Transfer')]")).click();//Transfer
	Reporter.log("Step - 16- verify ExpenditureItem screen");

	testReport.fillTableStep("Step 16", "verify ExpenditureItem screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_16");
...
//	expenditureitem_page_init.select_Costing_dropdown(Step_17_Costing_dropdown_DROPDOWN);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_17");

	Reporter.log("Step - 18- verify TransferExpenditureItem screen");

	testReport.fillTableStep("Step 18", "verify TransferExpenditureItem screen");

	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_18");

	Reporter.log("Step - 19- Fill Details form TransferExpenditureItem screen");

	testReport.fillTableStep("Step 19", "Fill Details form TransferExpenditureItem screen");
Thread.sleep(5000);
	transferexpenditureitem_page_init.set_ProjectNum_textbox(Step_19_ProjectNum_textbox_TEXTBOX);
	transferexpenditureitem_page_init.set_TaskNum_textbox(Step_19_TaskNum_textbox_TEXTBOX);
	getScreenshot(driver,Configurations.screenshotLocation , "Node_Activity__TransferCosts_","Step_19");
	...
	public void export(){
		...
		//driver.close();
		try {
			testReport.writeTestReporthtml(overallTestData, "Node_Activity__TransferCosts_");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
