...
/** Conformiq generated test case
	ProjectNumber____68_
*/
public class ProjectNumber____68_ extends PageObjectBase
{

	public ProjectNumber____68_()
	{
	}
	...
	testReport.generateGeneralInfo(overallTestData, "ProjectNumber____68_", "TC_ProjectNumber____68_", "",ne);
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_2");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_3");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_4");

	Reporter.log("Step - 5- verify HomePage screen");

	testReport.fillTableStep("Step 5", "verify HomePage screen");

	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_5");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_6");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_7");
	Thread.sleep(5000);
	Reporter.log("Step - 8- verify PFMMyProjects screen");

	testReport.fillTableStep("Step 8", "verify PFMMyProjects screen");

	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_8");
	...
	Thread.sleep(5000);
	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_9");
	...
	Thread.sleep(5000);
	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_10");
	...
	Thread.sleep(5000);
	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_11");
	...
	Thread.sleep(5000);
	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_12");

	Reporter.log("Step - 13- verify ProjectOverview screen");

	testReport.fillTableStep("Step 13", "verify ProjectOverview screen");

	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_13");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_14");
	...
	getScreenshot(driver,Configurations.screenshotLocation , "ProjectNumber____68_","Step_15");
	}
